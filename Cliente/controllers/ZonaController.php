...
class ZonaController extends Controller
{
     ...
     * @inheritdoc
     */
    public function actionZona(){
        
        $model = new \app\models\zona;
        
        if($model->load(Yii::$app->request->post()) && $model->validate())
        {
            $model->save();
            return $this->render('confirmarzona', ['model' => $model]);
        }
        else{
            
            return $this->render("zona",["model"=>$model]);
        }
    }
   ...
   /* public function behaviors()
    ...
    public function actionDelete($id)
    {
        ...
        return $this->redirect(['modificar']);
    }
